...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <h1 class="mt-3">Selamat Datang, <?php echo $rowSession['nama_admin'] ?>!</h1>
      ...
      <div class="row">
          ...
          <div class="col-md-4 text-white m-1">
          <a href="barangr/index.php" id="dataDashboard"><div class="row p-2 bg-secondary shadow-sm d-flex justify-content-around align-items-center rounded">
                  <div class="col-8">
